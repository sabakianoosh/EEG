...
def init_csv():
    ...
    with open(CSV_RAW, 'w', newline='') as f:
        csv.writer(f).writerow(["Timestamp", "Raw EEG"])
    with open(CSV_NOISE, 'w', newline='') as f:
        csv.writer(f).writerow(["Timestamp", "Poor Signal"])
    with open(CSV_ATTENTION, 'w', newline='') as f:
        csv.writer(f).writerow(["Timestamp", "Attention"])
    with open(CSV_MEDITATION, 'w', newline='') as f:
        csv.writer(f).writerow(["Timestamp", "Meditation"])
    with open(CSV_BRAINWAVES, 'w', newline='') as f:
        csv.writer(f).writerow(["Timestamp", "Delta", "Theta",
