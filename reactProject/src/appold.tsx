...
//   // Get last 10 rows
//   const lastTenRows = brainwaveData.slice(-11).slice(0,9);

//   // Map them to DataPoint[]
//   const newStream: DataPoint[] = lastTenRows.map((row: any) => ({
//     time: row.time,
//     alpha: row.alpha,
//     beta: row.beta,
//     gamma: row.gamma,
...
//   // Append to existing stream (keeping last 99)
//   setStream((prevStream) => [...prevStream.slice(-50), ...newStream]);
//   };
