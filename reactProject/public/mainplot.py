...
def plot_attention_meditation(att_file, med_file):
    ...
    plt.plot(df_att["Timestamp"], df_att["Attention"], label="Attention", color="blue")
    plt.plot(df_med["Timestamp"], df_med["Meditation"], label="Meditation", color="green")
...
def plot_noise(filename):
    ...
    plt.figure(figsize=(10, 4))
    plt.plot(df["Timestamp"], df["Poor Signal"], label="Noise", color="red")
